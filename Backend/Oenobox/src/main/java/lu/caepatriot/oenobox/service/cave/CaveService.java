package lu.caepatriot.oenobox.service.cave;

import lu.caepatriot.oenobox.dto.cave.SpaceDto;
...
import lu.caepatriot.oenobox.repository.cave.SpaceRepository;
...
import lu.caepatriot.oenobox.repository.cave.StorageUnitRepository;
import lu.caepatriot.oenobox.repository.cave.BottlePlacementRepository;
import lu.caepatriot.oenobox.repository.wine.WineRepository;
import lu.caepatriot.oenobox.repository.cave.CaveRepository;
...
public class CaveService {
    ...
    private BottlePlacementDto mapToBottlePlacementDto(BottlePlacement p) {
        ...
        if (p.getWine() != null) {
            ...
            // cepages could be added here too
            dto.setWine(wineDto);
        }
