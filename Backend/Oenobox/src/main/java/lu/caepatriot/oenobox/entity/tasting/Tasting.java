package lu.caepatriot.oenobox.entity.tasting;
...
public class Tasting {
    ...
    @Column(name = "cepage", columnDefinition = "TEXT")
    ...
    @JoinColumn(name = "tasting_id")
    private List<TastingAromesNature> aromesNature; // List of categories and their notes
    ...
    public List<TastingAromesNature> getAromesNature() {
        return aromesNature;
    }

    public void setAromesNature(List<TastingAromesNature> aromesNature) {
