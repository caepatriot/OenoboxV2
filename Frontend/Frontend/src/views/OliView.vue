...
import { buildOliSuggestions, extractPlacements, safeArray } from '@/utils/cellarMetrics.js'
...
<template>
  <section class="oeno-page">
    <div class="oeno-page__heading">
      ...
      <RouterLink to="/inventory" class="oeno-link-chip">
    ...
    <div class="oeno-hero mb-6">
      ...
      <div class="oeno-hero__aside">
        <div class="oeno-hero-badge">{{ cellarNames.join(' · ') || 'No cellar loaded yet' }}</div>
      </div>
    </div>
