      ...
      >
        <v-card-text class="pa-6">
          ...
          <div class="d-flex ga-3 flex-wrap">
            <v-btn class="oeno-btn oeno-btn--primary" @click="selectCaveAndGo(cave, `/cellar?caveId=${cave.id}`)">
              Explore workspace
            </v-btn>
            <v-btn class="oeno-btn oeno-btn--secondary" variant="flat" @click="selectCaveAndGo(cave, `/cellar?caveId=${cave.id}`)">
              Manage slots
            </v-btn>
          </div>
        </v-card-text>
