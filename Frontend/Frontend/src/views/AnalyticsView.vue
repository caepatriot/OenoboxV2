...
import { buildTypeDistribution, cellarCapacity, cellarOccupied, extractPlacements, extractUnits, formatCurrency, inventoryValue, occupancyRate, safeArray } from '@/utils/cellarMetrics.js'
