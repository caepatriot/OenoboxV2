...
import { cellarCapacity, cellarOccupied, occupancyRate, safeArray } from '@/shared/helpers/cellarMetrics.js'
        ...
        <v-card-text class="pa-6">
          ...
          <div class="oeno-mini-stats mb-5">
            <div class="oeno-soft-tile">
              ...
              <div class="oeno-soft-value">{{ Number(cave.temperature ?? 12).toFixed(1) }}Â°C</div>
            </div>
            <div class="oeno-soft-tile">
