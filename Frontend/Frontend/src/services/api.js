...
export const caveApi = {
  ...
  exportLayout: (id) => api.get(`/caves/${id}/export`),
  create: (caveData) => api.post('/caves', caveData),
  importLayout: (caveData) => api.post('/caves/import', caveData),
  update: (id, caveData) => api.put(`/caves/${id}`, caveData),
  restore: (id, caveData) => api.put(`/caves/${id}/restore`, caveData),
  ...
  bulkAddPlacements: (payload) => api.post('/caves/placements/bulk', payload),
