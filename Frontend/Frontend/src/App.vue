...
const navItems = [
  ...
  { to: '/cellar', label: 'Cellar', icon: 'mdi-view-grid-outline', match: '/cellar' },
...
const isLegacyRoute = computed(() => ['/cave-admin', '/cave-placement', '/tasting'].some((path) => route.path.startsWith(path)))
